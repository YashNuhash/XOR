...
export const GoogleGeminiEffect = ({
  ...
  useEffect(() => {
    ...
    const animatePaths = async () => {
      ...
      try {
        ...
        controls2.set({ pathLength: 0 })
        controls3.set({ pathLength: 0 })
        controls4.set({ pathLength: 0 })
  ...
  return (
    <div className="relative w-full h-[200px]">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/15 z-10">
        <Link href="/Collaborate" passHref>
          <Button
            size="lg"
            className="rounded-xl px-5 py-2 text-base bg-white/80 border border-gray-800 text-black-600 hover:bg-black/90 hover:text-white cursor-pointer"
          >
      ...
      >
        <motion.path
          ...
          animate={autoAnimate ? controls1 : undefined}
          style={
            !autoAnimate && pathLengths
              ? {
        ...
        <motion.path
          ...
          animate={autoAnimate ? controls2 : undefined}
          style={
            !autoAnimate && pathLengths
              ? {
        ...
        <motion.path
          ...
          animate={autoAnimate ? controls3 : undefined}
          style={
            !autoAnimate && pathLengths
              ? {
        ...
        <motion.path
          ...
          animate={autoAnimate ? controls4 : undefined}
          style={
            !autoAnimate && pathLengths
              ? {
        ...
        <motion.path
          ...
          animate={autoAnimate ? controls5 : undefined}
          style={
            !autoAnimate && pathLengths
              ? {

...
export function Button({
  ...
  return (
    <Component
      className={cn("relative h-10 w-40 overflow-hidden bg-transparent p-[1px] text-xl", containerClassName)}
      style={{
    ...
    >
      <div className="absolute inset-0" style={{ borderRadius: `calc(${borderRadius} * 0.96)` }}>
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn("h-20 w-20 bg-[radial-gradient(#4b5563_40%,transparent_60%)] opacity-[0.8]", borderClassName)}
          />
        </MovingBorder>
      </div>
